  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        {currentShift === 'Morning' && ( // Render only if it's the morning shift
    ...
    value={
      currentShift === 'Morning' ? morningAmount :
      currentShift === 'Afternoon' ? afternoonAmount :
      eveningAmount
    }
    onChangeText={text => {
      if (currentShift === 'Morning') setMorningAmount(text);
      else if (currentShift === 'Afternoon') setAfternoonAmount(text);
      else setEveningAmount(text);
    }}
    style={styles.input}
  />
